...
#### Google Ad Campaign:
To improve ad performance and lower customer acquisition costs, we designed an automated Google Ads marketing analytics system. We used techniques like geofencing, broad-match keyword targeting, and keyword bidding to create a highly targeted campaign. We conducted A/B testing between manually created campaigns and smart campaigns to evaluate success rates. We continuously tracked ad impressions, clicks, conversions, and ROAS (Return on Ad Spend) across various campaigns for IreneG Men’s Hairstylist. We used SQL to analyze our data and identify areas for growth.

#### Square Booking Site:
We updated the Square Booking Site user interface by reconfiguring the layout through the Square Dashboard. We reorganized service categories for easier navigation, applied brand-aligned colors and typography through Square’s Appearance Editor, and added detailed project descriptions.

#### Amazon:
To meet the stakeholders' need to sell products online, we created an Amazon Seller Central account and listed two products. We gathered the necessary product data—including titles, descriptions, pricing, and images—and uploaded it to the platform. We managed the process through a web browser, sourcing product information directly from the stakeholder. We relied on Amazon’s cloud infrastructure via Seller Central for data storage and hosting.

#### Squarespace:
We redesigned the entire website using Squarespace to make it more user-friendly, professional, and functional. We improved navigation, ensured consistency across mobile and desktop formats, integrated third-party platforms (including the booking platform and Amazon listings), and added customer feedback from Amazon and Google. We clearly defined all services and pricing and created an "About Us" section highlighting the owners—all with the goal of increasing bookings and customer interaction with the business.
